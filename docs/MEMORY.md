...
- **WIP**: Workspace completion — tab split, auto-cleanup, context menus, sidebar D&D fix

## Graph Architecture
- See [graph.md](./graph.md) for graph implementation details

## Current Direction (as of 2026-03-14)
...
- **In progress**: Workspace 완성 — splitTabToNewLeaf, 빈 패널 자동 정리, 사이드바 D&D 수정, 우클릭 뷰 전환 메뉴, 3 layout modes (Focus/List+Editor/Research)
- **Remaining**: Phosphor Icons + design tokens, surface polish (에디터, 위키링크, 검색), orphaned code cleanup
