...
export function BookShell({ shell, theme, showCover, setShowCover }: BookShellProps) {
      ...
      return (
        <div style={{ display: "flex", alignItems: "center", gap: 18, margin: "20px 0 48px" }}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <div style={{ fontFamily: shell.displayFont, fontSize: 22, fontWeight: 600 }}>{c.chapterTitle}</div>
          </div>
          <div style={{ flex: 1, height: 1, background: "currentColor", opacity: 0.3 }} />
        </div>
      )
