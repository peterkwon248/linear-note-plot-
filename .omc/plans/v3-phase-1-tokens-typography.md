...
`docs/v3-mockup/plot-v3-tokens.css` + `plot-base.css`:
...
(v3 mockup 정확한 값은 `docs/v3-mockup/plot-v3-tokens.css` 참조 — Task 1.1 mapping에서 확정)
...
Source: docs/v3-mockup/plot-v3-tokens.css + plot-base.css
