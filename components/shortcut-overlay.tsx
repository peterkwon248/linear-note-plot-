  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        {/* Footer */}
        <div className="flex items-center justify-center gap-1.5 border-t border-border px-6 py-3 text-[12px] text-muted-foreground">
          Press{" "}
          <kbd className="inline-flex min-w-[20px] items-center justify-center rounded border border-border bg-secondary px-1 py-0.5 font-mono text-[11px] text-muted-foreground">
            ?
          </kbd>{" "}
          or{" "}
          <kbd className="inline-flex min-w-[20px] items-center justify-center rounded border border-border bg-secondary px-1 py-0.5 font-mono text-[11px] text-muted-foreground">
