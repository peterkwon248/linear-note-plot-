...
export function WikiSidebar({
  ...
  return (
    <div className="w-[260px] shrink-0 border-l border-border-subtle overflow-y-auto px-4 py-5">
      {/* Categories */}
  ...
  return (
    <div style={{ paddingLeft: depth > 0 ? depth * 12 : 0 }}>
      <button
        ...
        className="flex w-full items-center gap-1.5 rounded-md px-1.5 py-1.5 text-left transition-colors duration-100 hover:bg-hover-bg"
      >
